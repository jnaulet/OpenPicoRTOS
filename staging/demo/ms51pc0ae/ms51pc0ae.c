...
static void mux_init(void)
{
    ...
    (void)mux_n76e003_mode(&P1, (size_t)1, MUX_N76E003_MODE_PUSHPULL);  /* PWM */
}

static int gpio_init(/*@partial@*/ struct ms51pc0ae *ctx)
{
...
static int uart_init(/*@partial@*/ struct ms51pc0ae *ctx)
{
...
static int pwm_init(/*@partial@*/ struct ms51pc0ae *ctx)
{
    static struct pwm_n76e003 PWM;

    (void)pwm_n76e003_init(&PWM, CLOCK_NUMICRO_FSYS);
...
int ms51pc0ae_init(struct ms51pc0ae *ctx)
{
    /* clocks */
    clock_init();
    mux_init();

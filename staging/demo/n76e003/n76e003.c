...
static void mux_init(void)
{
    ...
    (void)mux_n76e003_mode(&P1, (size_t)5, MUX_N76E003_MODE_QUASIBDIR); /* D2 */
    ...
    (void)mux_n76e003_mode(&P1, (size_t)2, MUX_N76E003_MODE_PUSHPULL);  /* TICK */
    (void)mux_n76e003_mode(&P1, (size_t)1, MUX_N76E003_MODE_OPENDRAIN); /* PWM */
}

static int gpio_init(/*@partial@*/ struct n76e003 *ctx)
{
    (void)gpio_n76e003_init(&ctx->TICK, (size_t)1, (size_t)2);
    (void)gpio_n76e003_init(&ctx->D2, (size_t)1, (size_t)5);

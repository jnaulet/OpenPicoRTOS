...
/* IPC test */
static struct UNPRIVILEGED_DATA picoRTOS_mutex mutex = PICORTOS_MUTEX_INITIALIZER;
static struct UNPRIVILEGED_DATA picoRTOS_cond cond = PICORTOS_COND_INITIALIZER;

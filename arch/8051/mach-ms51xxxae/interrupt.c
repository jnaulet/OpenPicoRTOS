...
#define C99_EIE_EPWM0 (1 << 3)
#define C99_EIE_ECAP  (1 << 2)
#define C99_EIE_EPI   (1 << 1)
#define C99_EIE_EI2C  (1 << 0)

#define C99_EIE1_EPWM3 (1 << 5)
#define C99_EIE1_EPWM2 (1 << 4)
#define C99_EIE1_EPWM1 (1 << 3)
...
void arch_enable_interrupt(picoRTOS_irq_t irq)
{
    ...
    case IRQ_PWMF_0: C99_EIE |= C99_EIE_EPWM0; break;
    ...
    case IRQ_PWMF_1: C99_EIE1 |= C99_EIE1_EPWM1; break;
    case IRQ_PWMF_2: C99_EIE1 |= C99_EIE1_EPWM2; break;
    case IRQ_PWMF_3: C99_EIE1 |= C99_EIE1_EPWM3; break;
    default:

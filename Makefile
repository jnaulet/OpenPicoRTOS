...
distcheck: FORCE
	cd test && ./run_demo_staticcheck.sh
	cd test && ./run_staging_demo_staticcheck.sh
	cd test && ./run_demo_build.sh
	cd test && ./run_staging_demo_build.sh
	cd test && ./run_demo_amigaball_build.sh
	@echo ""

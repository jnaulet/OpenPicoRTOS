...
static int setup_prescaler(clock_attiny1x_pdiv_t pdiv)
{
    if (!picoRTOS_assert(pdiv < CLOCK_ATTINY1X_PDIV_COUNT)) return -EINVAL;

    switch (pdiv) {
    case CLOCK_ATTINY1X_PDIV_2: clocks.per_div = (clock_freq_t)2; break;
    case CLOCK_ATTINY1X_PDIV_4: clocks.per_div = (clock_freq_t)4; break;
    case CLOCK_ATTINY1X_PDIV_8: clocks.per_div = (clock_freq_t)8; break;
    case CLOCK_ATTINY1X_PDIV_16: clocks.per_div = (clock_freq_t)16; break;
    case CLOCK_ATTINY1X_PDIV_32: clocks.per_div = (clock_freq_t)32; break;
    case CLOCK_ATTINY1X_PDIV_64: clocks.per_div = (clock_freq_t)64; break;
    case CLOCK_ATTINY1X_PDIV_6: clocks.per_div = (clock_freq_t)6; break;
    case CLOCK_ATTINY1X_PDIV_10: clocks.per_div = (clock_freq_t)10; break;
    case CLOCK_ATTINY1X_PDIV_12: clocks.per_div = (clock_freq_t)12; break;
    case CLOCK_ATTINY1X_PDIV_24: clocks.per_div = (clock_freq_t)24; break;
    case CLOCK_ATTINY1X_PDIV_48: clocks.per_div = (clock_freq_t)48; break;
    default:
        picoRTOS_break();
...
int clock_attiny1x_init(struct clock_settings *settings)
{
    ...
    case CLOCK_ATTINY1X_CLKSEL_OSC20M: res = setup_osc20m(); break;
    case CLOCK_ATTINY1X_CLKSEL_OSCULP32K: res = setup_osculp32k(); break;
    case CLOCK_ATTINY1X_CLKSEL_XOSC32K: /*@fallthrough@*/
    case CLOCK_ATTINY1X_CLKSEL_EXTCLK:  /*@fallthrough@*/
    default:
        picoRTOS_break();
        /*@notreached@*/ return -EINVAL;
    }
...
{
    if (!picoRTOS_assert(clkid < (clock_id_t)CLOCK_ATTINY1X_COUNT))
        return (clock_freq_t)-EINVAL;

    switch (clkid) {
    case CLOCK_ATTINY1X_CLK_CPU: return clocks.clk_main / clocks.per_div;
    case CLOCK_ATTINY1X_CLK_RTC: return (clock_freq_t)OSCULP32K_HZ;
    case CLOCK_ATTINY1X_CLK_WDT: return (clock_freq_t)(OSCULP32K_HZ >> 5);
    case CLOCK_ATTINY1X_CLK_TCD: return clocks.freqsel;
    default: break;
    }
